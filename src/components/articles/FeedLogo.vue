<template>
  <div class="logos">
    <div class="logos_left">
      <i v-if="isLikeUser" @click="unlike(feed.id);isLike()" class="logo_img fas fa-heart heart-color"></i>
      <i v-else @click="like(feed.id);isLike()" class="logo_img far fa-heart"></i>

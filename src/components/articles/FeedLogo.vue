<template>
  <div class="logos">
    <div class="logos-left">
      <i v-if="isLikeUser" @click="unlike(feed.id);isLike()" class="logo-img fas fa-heart heart-color"></i>
      <i v-else @click="like(feed.id);isLike()" class="logo-img far fa-heart"></i>
      <router-link :to="{ name: 'FeedDetail', params: { id: feed.id, feed: feed } }"><i class="logo-img far fa-comment"></i></router-link>
